...
function FitnessModal({ onClose }: { onClose: () => void }) {
    ...
    const safeMinutes = stats.todayMinutes || 0;
    const safeGoal = stats.weeklyGoal || 120; // Default to 120 if missing
    
    // Calculate using safe values to avoid NaN
    const percentage = Math.min(100, Math.round((safeMinutes / safeGoal) * 100));
                        ...
                        <div className="flex justify-center mb-6 relative">
                            <div className="relative w-40 h-40 flex items-center justify-center">
                                ...
                                <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center">
                                    ...
                                    <div className="text-3xl font-bold text-white">{safeMinutes}</div>
